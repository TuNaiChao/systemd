...
CONFIG_PARSER_PROTOTYPE(config_parse_socket_ip_ttl);
CONFIG_PARSER_PROTOTYPE(config_parse_socket_keepalive_time);
CONFIG_PARSER_PROTOTYPE(config_parse_socket_keepalive_probes);
